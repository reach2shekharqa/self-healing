...
public class SelfHealingEngine {
        ...
        public WebElement heal(
                ...
                if (candidates.isEmpty()) {
                        ...
                        DecisionContextBuilder builder = new DecisionContextBuilder();

                        HealingDecisionContext decisionContext = builder.build(context, snapshot);

                        System.out.println("\n========== AI Decision Context ==========");
                        System.out.println(decisionContext);
                        System.out.println("=========================================\n");

                        throw new RuntimeException("No healing candidates found");
                }
